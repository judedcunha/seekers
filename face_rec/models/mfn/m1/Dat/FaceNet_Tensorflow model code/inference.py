...
def get_parser():
    ...
    parser.add_argument('--pretrained_model', type=str, default='./output/ckpt_best/tinyFaceNet_best_ckpt',
                        help='Load a pretrained model before training starts.')
    parser.add_argument('--log_device_mapping', default=False, help='show device placement log')
    parser.add_argument('--model_type', default=1, help='FaceNet or TinyFaceNet')
