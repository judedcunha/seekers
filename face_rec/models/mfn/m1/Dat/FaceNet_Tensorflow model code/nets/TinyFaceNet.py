...
# Tensorflow mandates these. Tiny version is with depth 256 and uses the tf.nn.elu(exponential linear function) activation function and with changes in the invresblock
...
def mobilenet_v2_base(inputs,
  ...
  with tf.variable_scope(scope, 'FaceNet', [inputs]):
...
def mobilenet_v2(inputs,
  ...
  with tf.variable_scope(scope, 'FaceNet', [inputs], reuse=reuse) as scope:
