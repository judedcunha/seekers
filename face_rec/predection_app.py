...
from face_rec.flask_train import flask_training
...
class Model(object):
    def __init__(self):
        ...
        self.saver = tf.train.import_meta_graph('face_rec/models/mfn/m1/mfn.ckpt.meta')
    ...
    def predict(self, frame):
        ...
        self.saver.restore(self.sess, 'face_rec/models/mfn/m1/mfn.ckpt')
