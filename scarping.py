...
ALLOWED_EXTENSIONS = set(['zip,jpg'])
...
def getdata():
   ...
   for i in data:
      ...
      if (i['Full_name'].lower() == data_filter[0].lower() or data_filter[0] == "") and (i['Gender'].lower() == data_filter[1].lower() or data_filter[1] == "") and (i['Age'][0:1] == data_filter[2][0:1] or data_filter[2] == "") and (i['Height'][0:1] == data_filter[3][0:1] or data_filter[3] == ""): 
         
         print(i['Aadhar_id'])
         final_str = final_str+ i['Aadhar_id']+ ","
